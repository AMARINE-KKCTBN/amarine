...
while(1):
    ...
    hL = cv2.getTrackbarPos('H Lower','hsv')
    hH = cv2.getTrackbarPos('H Higher','hsv')
    sL = cv2.getTrackbarPos('S Lower','hsv')
    sH = cv2.getTrackbarPos('S Higher','hsv')
    vL = cv2.getTrackbarPos('V Lower','hsv')
    vH = cv2.getTrackbarPos('V Higher','hsv')
